...
const MyStopwatch = ({ time, id, running, name, startTime, dispatch }) => {
    ...
    return (
        <div className={running ? `${styles.stopwatch} ${styles.active}` : styles.stopwatch}>
            ...
            <div>
                <p className={styles.stopwatch_time}>{formatTime(time)}</p>
                <button onClick={handlePause} className={styles.stopwatch_pause}>{running
                ...
                <button onClick={handleRemove} className={styles.stopwatch_delete}>
